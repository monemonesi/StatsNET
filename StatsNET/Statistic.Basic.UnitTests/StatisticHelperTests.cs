...
namespace Statistic.Basic.UnitTests
{
    ...
    public class StatisticHelperTests
    {
        ...
        public void GetAbsoluteFrequencyShouldReturnTheCorrectFrequencyForASpecificInterval(string data, double startInterval, double endInterval, double expected)
        {
